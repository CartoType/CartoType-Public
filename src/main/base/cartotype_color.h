...
/** Opaque dark grey. */
constexpr uint32_t KDarkGrey = 0xFF555555;
/** Opaque dark gray. */
constexpr uint32_t KDarkGray = 0xFF555555;
/** Opaque dark red. */
constexpr uint32_t KDarkRed = 0xFF000080;
/** Opaque dark green. */
constexpr uint32_t KDarkGreen = 0xFF008000;
/** Opaque dark yellow. */
constexpr uint32_t KDarkYellow = 0xFF008080;
/** Opaque dark blue. */
constexpr uint32_t KDarkBlue = 0xFF800000;
/** Opaque dark magenta. */
constexpr uint32_t KDarkMagenta = 0xFF800080;
/** Opaque dark cyan. */
constexpr uint32_t KDarkCyan = 0xFF808000;
/** Opaque red. */
constexpr uint32_t KRed = 0xFF0000FF;
/** Opaque green. */
constexpr uint32_t KGreen = 0xFF00FF00;
/** Opaque yellow. */
constexpr uint32_t KYellow = 0xFF00FFFF;
/** Opaque blue. */
constexpr uint32_t KBlue = 0xFFFF0000;
/** Opaque magenta. */
constexpr uint32_t KMagenta = 0xFFFF00FF;
/** Opaque cyan. */
constexpr uint32_t KCyan = 0xFFFFFF00;
/** Opaque grey. */
constexpr uint32_t KGrey = 0xFFAAAAAA;
/** Opaque gray. */
constexpr uint32_t KGray = KGrey;
/** Opaque white. */
