...
class TypefaceInstance
    ...
    bool operator==(const TypefaceInstance& aInstance) const
        { return Size == aInstance.Size && Transform == aInstance.Transform; }
    /** The inequality operator. */
    bool operator!=(const TypefaceInstance& aInstance) const
...
class MLabelHandler
    ...
    /** Handle a label, passed as a 32bpp RGBA bitmap to be drawn at aTopLeft. */
    virtual void operator()(const BitmapView& aLabelBitmap,const Point& aTopLeft) = 0;
    };
