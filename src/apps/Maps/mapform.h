...
class MapForm: public QOpenGLWidget
    ...
    public:
    explicit MapForm(QWidget* aParent,MainWindow& aMainWindow,
    ...
    std::shared_ptr<CartoType::StyleSheetData> m_saved_style_sheet; // a copy of the ordinary style sheet kept while the custom style sheet is in use
